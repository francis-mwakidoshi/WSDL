 ...
 * 
 */
@WebServiceClient(name = "TestWS", targetNamespace = "http://ws.psd.safaricom.com/", wsdlLocation = "http://0f4cb733.ngrok.io/TestWebService/TestWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://0f4cb733.ngrok.io/TestWebService/TestWS?wsdl");
